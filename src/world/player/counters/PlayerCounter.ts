...
export class PlayerCounter {
	...
	constructor(
		...
		this.setupEventListeners(sceneToUse, sceneToListen, increaseEvent, decreaseEvent, zeroEvent);
	}
	...
	setupEventListeners(sceneToUse: HUD, sceneToListen: Gameplay, increaseEvent, decreaseEvent, zeroEvent) {
