...
export function texture(
  { scene, name, width, height }: TextureConfig,
  { before, after }: TextureFunctions
) {
...
export function circlesDrawer(
  configs: { color: number; x: number; y: number; radius: number }[]
) {
