import { cirlceSizeNames, unitCircleChainsConfig, unitArrowHeadConfig } from "./const";
import { weaponDists, weaponRadius } from "./data";
import { AllWeaponHeights, WeaponRadius, AllWeaponDists, AllWeaponTopLefts } from "./types";

export function weaponHeightPerSize() {
	let result = {};
...
export function weaponRadiusPerSize() {
	let result = {};
...
export function weaponDistsPerSize() {
	let result = {};
	for (let unitSize of cirlceSizeNames) {
		let { bigRadius, smallRadius } = weaponRadius[unitSize];
...
export function weaponTopLeftsPerSize() {
	let result = {};
